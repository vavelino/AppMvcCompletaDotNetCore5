        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Street = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Number = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierViewModel_AddressViewModel_AddressId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductViewModelSupplierViewModel",
                columns: table => new
                {
                    ProductsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SuppliersId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductViewModelSupplierViewModel", x => new { x.ProductsId, x.SuppliersId });
                    table.ForeignKey(
                        name: "FK_ProductViewModelSupplierViewModel_ProductViewModel_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "ProductViewModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductViewModelSupplierViewModel_SupplierViewModel_Supplier~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductViewModelSupplierViewModel_SuppliersId",
                table: "ProductViewModelSupplierViewModel",
                column: "SuppliersId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierViewModel_AddressId",
                table: "SupplierViewModel",
                column: "AddressId");
        }
